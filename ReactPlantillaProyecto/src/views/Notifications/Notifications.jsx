...
import FireWifi from "components/Firebase.js";
    ...
    return (
      <Card>
        <CardHeader color="primary">
          <h4 className={classes.cardTitleWhite}>Alarmas IOT Eureka! Technology</h4>
